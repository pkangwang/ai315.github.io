import{_ as s,c as a,o as n,a2 as p}from"./chunks/framework.84TDCN6B.js";const g=JSON.parse('{"title":"文本插值","description":"","frontmatter":{},"headers":[],"relativePath":"Vue.js/文本插值.md","filePath":"Vue.js/文本插值.md"}'),t={name:"Vue.js/文本插值.md"},e=p(`<h1 id="文本插值" tabindex="-1">文本插值 <a class="header-anchor" href="#文本插值" aria-label="Permalink to &quot;文本插值&quot;">​</a></h1><p>文本插值比较简单，就是使用双大括号将变量包裹住，vue会自动解析出该变量的值渲染到页面，如下示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script setup&gt;</span></span>
...
<span class="line"><span>&lt;/template&gt;</span></span></code></pre></div>`,5),l=[e];function c(i,o,r,d,_,u){return n(),a("div",null,l)}const m=s(t,[["render",c]]);export{g as __pageData,m as default};
