import{_ as s,c as a,o as n,a2 as p}from"./chunks/framework.84TDCN6B.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Android/Flutter构建安卓APP的踩坑记录.md","filePath":"Android/Flutter构建安卓APP的踩坑记录.md"}'),e={name:"Android/Flutter构建安卓APP的踩坑记录.md"},l=p(`<h2 id="gradle-构建时卡住" tabindex="-1">Gradle 构建时卡住 <a class="header-anchor" href="#gradle-构建时卡住" aria-label="Permalink to &quot;Gradle 构建时卡住&quot;">​</a></h2><p>当运行 flutter build apk 的时候会一直卡在“Running Gradle task &#39;assembleRelease&#39;...”，这表示flutter在下载一些资源，但是由于服务器在国外，所以会卡住。此时需要去两个文件里面将下载服务器改为国内的源。</p><ul><li>“项目目录\\android\\build.gradle”：</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>buildscript {</span></span>
